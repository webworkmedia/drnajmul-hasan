(() => {
  ...
  const bn = {
    ...
    'MBBS, BCS, FCPS (Orthopaedic), FICS (Ortho), FACS (USA)': 'MBBS, BCS, FCPS (অর্থোপেডিক), FICS (অর্থো), FACS (USA)',
    ...
    'Specialist Orthopaedic and Spine Surgeon': 'বিশেষজ্ঞ অর্থোপেডিক ও স্পাইন সার্জন',
